...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            ...
            <a class="nav-link" href="./index.php/usuarios/index">Home <span class="sr-only">(current)</span></a>
          </li>
  ...
  <script>
    window.jQuery || document.write('<script src=" <?php echo base_url(); ?>bootstrap/js/jquery.slim.min.js"><\/script>')
  </script>
