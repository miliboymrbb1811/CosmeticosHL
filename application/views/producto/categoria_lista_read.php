        ...
        <div class="row"><!-- Inicio Div row -->
            <div class="col-md-12 col-sm-12 "><!-- Inicio Div col-md-12 col-sm-12  -->
                <div class="x_panel"><!-- Inicio Div x_panel -->
                    <div class="x_title">
                    <title > <i class="fa fa-list"></i> Categorías. </title>
                        <h2>
                        ...
                        <div class="row"><!-- Inicio Div row 2 -->
                            <div class="col-sm-12"><!-- Inicio Div col-sm-12 2 -->
                                <div class="card-box table-responsive"><!-- Inicio Div card-box table-responsive -->
                                    ...
                                    ?>
                                        <button type="submit" style= "float: right " class=" btn btn-round btn-info"> <!--style= "float: right " para alinear ala derecha -->
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <?php echo form_close();?>
                            <button class="btn btn-outline-danger" data-toggle="tooltip"  onclick="return confirm_modalFotos(<?php echo $row->idCategoria; ?>)"  data-placement="top" title="Deshabilitar">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-list"></i> Lista de categoria deshabilitadas.</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </li>
