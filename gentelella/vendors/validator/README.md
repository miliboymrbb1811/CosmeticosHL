...
A generic callback function to have the form validated on the **Submit** event. You can also include your own empleadol validations before the **checkAll()** call.
